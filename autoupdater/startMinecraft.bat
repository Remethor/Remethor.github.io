...
start "" /I /HIGH ./runtime/64/jre1.8.0_211/bin/javaw.exe ^
...
-Djava.library.path=./javaLibraries -cp ^
./.minecraft/libraries/net/minecraft/launchwrapper/1.12/launchwrapper-1.12.jar;^
./.minecraft/libraries/org/ow2/asm/asm-all/5.2/asm-all-5.2.jar;^
...
./.minecraft/libraries/org/scala-lang/plugins/scala-continuations-library_2.11/1.0.2/scala-continuations-library_2.11-1.0.2.jar;^
./.minecraft/libraries/org/scala-lang/plugins/scala-continuations-plugin_2.11.1/1.0.2/scala-continuations-plugin_2.11.1-1.0.2.jar;^
...
./.minecraft/libraries/net/minecraftforge/forge/1.12.2-14.23.5.2847/forge-1.12.2-14.23.5.2847.jar;^
...
./.minecraft/libraries/org/lwjgl/lwjgl/lwjgl-platform/2.9.4-nightly-20150209/lwjgl-platform-2.9.4-nightly-20150209.jar;^
...
net.minecraft.launchwrapper.Launch --username %NICK% --version 1.12.2 --gameDir ./.minecraft --assetsDir ./assets --assetIndex 1.12 --uuid %uuid% --accessToken 5cf806db8b5d09e87c6f95e9ec28c941 --userType mojang --tweakClass net.minecraftforge.fml.common.launcher.FMLTweaker --versionType Forge
exit